...
const en = {
  ...
  extra: <span><a href={'https://github.com/santistebanc/superCar'}><Icon name="github square"/>github repo</a>
  <a href={'http://santistebanc.tk/superCar'}><Icon name="play"/>run demo</a></span>
}
