...
const en = {
  ...
  extra: <span><a href={'https://github.com/santistebanc/Trivia'}><Icon name="github square"/>github repo</a>
  <a href={'http://santistebanc.tk/creapp'}><Icon name="play"/>landing page</a>
  <a href={'http://santistebanc.tk/Trivia'}><Icon name="play"/>run demo</a></span>
}
