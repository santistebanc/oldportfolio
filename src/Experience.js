...
const en = {
  now: 'Now',
  studies: <span className="black">Bachelor's Degree in <i>Informatics Engineering</i> at <strong className="blue">Tecnológico de Monterrey</strong> in SLP, Mexico.<p className="jobdesc">Object Oriented Programming, Data Structures, Databases, Networks, Servers, Operating Systems, IT Security, Cloud Computing</p></span>,
