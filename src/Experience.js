...
const en = {
  ...
  mls: <span className="black">Internship at software development start-up company <strong className="blue">Market Logic Software</strong> in Berlin<p className="jobdesc">Development of new features for the company's product software. Design and Programming of UI Components in <i>React.js</i> including graphs and charts with <i>D3.js</i> and dynamic widgets.</p></span>,
  ...
  aisa: <span className="black">Internship at <strong className="blue">AISA</strong>, Development of management system for government agency of public property registry <i>(Registro Público de la Propiedad)</i><p className="jobdesc">Software Development in a project to manage official documents in digital form. Was in charge of designing and programming the UI Forms and Controls using <i>Windows Presentation Foundation</i> framework in C# and a large SQL database.</p></span>
}
