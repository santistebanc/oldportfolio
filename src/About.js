...
const en = {
  ...
  consider: <span>I consider myself a sensible and practical person, I like to make rational and informed decisions. I am friendly, kind and open-minded. I can be imaginative when coming up with new ideas and creative when finding solutions to problems. I can be determined and resolute when the goal is right, yet I have no qualms about quitting when the situation warrants it.</span>,
  ...
  curious: <span>One other particular thing about myself, is that I am relentlessly curious. I want to know how it all works; physics, history, politics, philosophy, mathematics; everyday I learn a little bit more about those. I am most fascinated by the exciting new advances in science and technology, and the mind-blowing current events in the world.</span>,
  goals: <span>Right now, my first goals in life, are on one side, professionally: grow in my career, seek new job opportunities, gain expertise, earn a living. But on the other side, most importantly, I want to grow personally: I have been living a kind of spoiled, very comfortable life in my hometown, not really facing many challenges. So now I am seeking to throw myself out there and learn to be an integral person.</span>,
}
