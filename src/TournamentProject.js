...
const en = {
  ...
  extra: <List horizontal>
    <List.Item><a href={'https://github.com/santistebanc/roundRobin'}><Icon name="github square"/>github repo</a></List.Item>
    <List.Item><a href={'http://santistebanc.tk/roundRobin'}><Icon name="play"/>run demo</a></List.Item>
  </List>
}
